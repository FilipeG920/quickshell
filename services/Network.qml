...
Singleton {
    ...
    // Consumer visibility control - set to false pause polling when UI is hidden
    ...
    function connectToNetwork(ssid: string, password: string): void {
        ...
        // Checks for dangerous characters that could be used for injection
        ...
        if (password && password.length > 0) {
            ...
            // Connect to saved network using connection name (which is usually SSID)
