...
Item {
    ...
    readonly property color normalBatteryColor: {
        if (root.isLow)
        return root.pywal.error

        if (root.isWarning)
        return root.pywal.warning

        if (root.batteryLevel >= 60)
        return Qt.rgba(root.pywal.foreground.r, root.pywal.foreground.g, root.pywal.foreground.b, 0.7)

        return Qt.rgba(root.pywal.foreground.r, root.pywal.foreground.g, root.pywal.foreground.b, 0.6)
    }

    readonly property color resolvedCompactBatteryColor: {
        if (root.showExpandedMode || root.justPluggedIn)
        return root.chargingColor

        if (root.isPluggedIn && (root.isLow || root.isWarning))
        return root.normalBatteryColor
        ...
        Row {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    color: "transparent"
                    border.width: 1.5
                    border.color: root.resolvedCompactBatteryColor
                    ...
                    Rectangle {
                        ...
                        radius: 1.5
                        color: root.resolvedCompactBatteryColor
